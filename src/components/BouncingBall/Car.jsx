...
export function Car(props) {
  const { nodes, materials } = useGLTF(
    "/public/models/1975-porsche/model-transformed.glb"
  );
  return (
    <group {...props} dispose={null} scale={0.95} position={[0, 0, -3]} rotation={[0, angleToRadian(-50), 0]}>
...
useGLTF.preload("/public/models/1975-porsche/model-transformed.glb");
